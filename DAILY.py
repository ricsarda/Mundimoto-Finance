...
Purchaces = openpyxl.load_workbook(comp_alb)
hoja = Purchaces.active
...
Report = ['UNITS B2C' , 'INVOICED B2C' , 'MARGIN B2C' , 'UNITS B2B' , 'INVOICED B2B' , 'MARGIN B2B', 'UNITS SCRAP' , 'INVOICED SCRAP' , 'MARGIN SCRAP' , 'FINANCING UNITS' , 'TOTAL FINANCED' , 'COMISSION' , 'BASIC UNITS' , 'BASIC INVOICED' , 'COMPLETE UNITS' , 'COMPLETE INVOICED' , 'PREMIUM UNITS' , 'PREMIUM INVOICED' , 'STREET UNITS' , 'STREET INVOICED' , 'SPORT UNITS' , 'SPORT INVOICED' ,'SEGURO UNITS', 'SEGURO INVOICED','PURCHASES UNITS' , 'PURCHASES INVOICED' , 'STOCK UNITS' , 'STOCK VALUE' , 'RETURNED B2C' , 'RETURNED B2B' , 'RETURNED SCRAPS' , 'RETURNED NV' , 'RETURNED']
Resultados = [B2Cunidades , B2CVenta , B2Cmargen , B2Bunidades , B2BVenta , B2Bmargen , Desguaceunits , DesguaceVenta , Desguacemargen , 0 , 0 , 0, BASICUNITS , BASICINVO , COMPLETOUNITS , COMPLETOINVO , PREMIUMUNITS , PREMIUMINVO , STREETUNITS , STREETINVO , SPORTUNITS , SPORTINVO ,segurounits ,seguroinvo , Purchacesunidades , Purchacesimporte , 0 , 0 , B2CACunidades ,  B2BACunidades , DesguaceACunits ,B2CVNACunidades, ValortotalAC ]
